        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">@lang('files')</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('/admin')}}">@lang('home')</a>
                                </li>
                                <li class="breadcrumb-item"><a
                                        href="{{url('/admin/files')}}">@lang('files')</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <form action="" id="edit_form" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <label for="edit_file">@lang('file')</label>
                                <div class="form-group">
                                    <div class="fileinput fileinput-exists"
                                         data-provides="fileinput">
                                        <div class="fileinput-preview thumbnail"
...
@section('scripts')
    <script>
        var url = '{{url(app()->getLocale()."/admin/files")}}/';
        ...
        var oTable = $('#datatable').DataTable({
            ...
            searching: false,
            ajax: {
                url: '{{ url(app()->getLocale().'/admin/files/indexTable')}}',
                data: function (d) {
                    d.name = $('#s_name').val();
                    d.file = $('#s_file').val();
